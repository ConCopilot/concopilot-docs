...
Source code: [plugin.py](https://github.com/ConCopilot/concopilot/blob/main/concopilot/framework/plugin/plugin.py)
<br>
Config file example: [config.yaml](https://github.com/ConCopilot/concopilot/blob/main/config/plugin/config.yaml)
