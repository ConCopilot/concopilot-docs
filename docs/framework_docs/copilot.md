...
[Source code](https://github.com/ConCopilot/concopilot/tree/v0.0.1/concopilot/basic/copilot)
...
Here is a runnable "[config.yaml](https://github.com/ConCopilot/concopilot/blob/v0.0.1/concopilot_examples/copilot/auto/.config/config.yaml)" example.
